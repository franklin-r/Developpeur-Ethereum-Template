...
contract DiscountedBuy {
    ...
    function buy() public payable {
        // No number such as 3 * msg.value == 1 ether
        // Can be fixed with >= or dividing basePrice instead
...
contract Vault {
    ...
    function redeem() public {
        // Re-entrency
        // Should reset balance before call()
...
contract HeadTail {
     ...
     */
     // Front-running. partyA can call this before partyB if he sees he makes a good guess.
     // Could specify in the construtor who is the future partyB to avoid that.
...
contract SimpleToken {
     ...
     */
     // Can create money by sending negative amount
...
contract LinearBondedCurve {
    ...
    // Can create a loop of buy and sell to empty the contract
    function buy() public payable {
        // Tends to 0
        uint tokenToReceive =  (1e18 * msg.value) / (1e18 + totalSupply);
        balances[msg.sender] += tokenToReceive;
        // Total supply should be increased before computation or tokenToReceive
...
contract CommonCoffers {
    ...
    function withdraw(uint _amount) external {
        // Could equal 0 if numerator too small and then empty the contract
